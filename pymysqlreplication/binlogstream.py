...
class BinLogStreamReader(object):
    ...
    def __init__(self, connection_settings, server_id, ctl_connection_settings=None, resume_stream=False,
                 ...
                 table_filter=None, freeze_schema=False,
        ...
        Attributes:
            ...
            table_filter: a callable that receives a schema name and a table
                          name and returns whether or not it should be processed
        ...
        self.__table_filter = table_filter
